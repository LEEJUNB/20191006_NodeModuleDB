...
REST API는 REpresentational State Transfer의 약어. 네트워크 구조의 한 형식. 서버 자원 정의. 자원 주소 지정 방법을 의미
...
다음처럼 주소 구조 정리한 후 코딩시작해야 체계적 프로그래밍에 도움
HTTP메서드 ; 주소 ; 역할
GET ; / ; restFront.html파일제공
GET ; /about ; about.html파일제공
POST ; /users  ;사용자등록
